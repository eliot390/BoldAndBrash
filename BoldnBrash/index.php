<?php
  ...
  include('session.php');
    ...
    echo "<body>
      <div id='main'>
        <div class='row'>
          <div class='col-md-12' id='logged-in'>You are now logged in as ".$row['displayName']."</div>
        </div>
        <div id='heading' class='row'>
          <div id='title' class='col-md-3'>Welcome</div>
        ...
        <div id='main-menu' class='row'>
          ...
          <div class='col-md-4' id='menu-options'><a href='add_listing.php'>Create Art Listing</a>
            <br><a href='search_resources.php'>Search Listings</a>
            <br><a href='gallery.php'>View Gallery</a>
            <br><a href='new_incident.php'>Upload Art for Gallery</a>
            <br><a href='purchase.php'>Purchase Art</a>
          </div>
          <div class='col-sm-4'></div>
        </div>
        <div class='row'>
...
<head>
  <meta charset="utf-8">
  <title>Bold and Brash Art Listings</title>
